...
class ActividadesControllerTest {
    ...
    void setUp() throws Exception {
        ...
        Field listaField = ActividadesController.class.getDeclaredField("listaActividades");
        listaField.setAccessible(true);
        listaField.set(controller, listaActividades);

        Field serviceField = ActividadesController.class.getDeclaredField("actividadService");
    ...
    void seleccionarActividad_conSeleccion_navegaADetalle() {
        try (MockedStatic<ScreenManager> screenMock = mockStatic(ScreenManager.class);
             MockedStatic<DetalleActividadController> detalleMock = mockStatic(DetalleActividadController.class)) {
